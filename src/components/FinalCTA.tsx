  ...
  return (
    <section className="px-6 py-20 md:px-12 lg:px-24">
      <div className="container-page">
        ...
        >
          <div className="relative overflow-hidden rounded-[32px] bg-[#416b62] px-8 py-12 text-white md:px-12 hover-lift">
            <div className="absolute inset-0 opacity-18">
              <Image
                src="/images/cta-texture.jpg"
                alt="Textura artística abstracta"
                fill
                className="art-fade-mask object-cover"
              />
            </div>
            ...
            <div className="relative z-10 max-w-3xl">
              ...
              <p className="mt-5 leading-8 text-white/85">
                La primera sesión es gratuita y sin compromiso. Puede ser un espacio
                para entender qué estás viviendo, resolver tus dudas y valorar si
                este acompañamiento encaja contigo en este momento.
              </p>
